...
namespace Fo76ini
{
    public partial class Localization
    {
        private static void AddSharedStrings()
        {
            ...
            localizedStrings["modSidePanel_WarningNoFilesAvailableToPack"] = "Warning: Couldn't find any (valid) files to pack to an archive. Archive2 might fail during deployment.";
